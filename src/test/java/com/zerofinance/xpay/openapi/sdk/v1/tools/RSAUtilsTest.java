...
public class RSAUtilsTest {
    ...
    public void encrypt() throws Exception {
        String str = "aaaaaa";
        String encrytpStr = new String(RSAUtils.encrypt(str.getBytes(), publicKey));
    ...
    public void decode() throws Exception {
        String str = "aaaaaa";
        String decryptStr = new String(RSAUtils.decrypt(RSAUtils.encrypt(str.getBytes(), publicKey), privateKey));
